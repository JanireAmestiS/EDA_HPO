...
def fit_CNN(hyperparameters, model):
    ...
    for epoch in range(25):  
        ...
        print('prueba', running_loss / train_div, valid_loss / valid_div ,running_acc / train_div, valid_acc / valid_div)
...
def cost_function(solution: np.array, contador=contador, variables = variables, psb = psb):
    ...
    torch.save(model, 'model_ind%s_gen%s.pth'%(contador.individuo, contador.generacion))
